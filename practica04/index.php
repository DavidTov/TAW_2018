...
//$total_users = 0;
//foreach ($user_access as $persona) {
//  $total_users += 1;
//}

//echo "Conteo de los usuarios <br> $total_users";
?>
<!doctype html>
          ...
          <section class="section">
            <div class="content" data-slug="panel1">
              ...
              <table>
                ...
                <tbody>
                  <?php foreach( $user_access as $_user){ ?>
                  <tr>
                    <td><?php echo $_user->id ?></td>
                    <td><?php echo $_user->nombre ?></td>
                    <td><?php echo $_user->email ?></td>
                    <?//Se generan dos botones, que redireccionan a acutalizaar y eliminar respectivamente."?>
                    <td><a href="./update.php?id=<?php echo($_user->id); ?>" class="button radius tiny warning"">Modificar</a></td>
                    <td><a href="./delete.php?id=<?php echo($_user->id); ?>" class="button radius tiny alert"     onClick="wait();">Eliminar</a></td>
                  </tr>
                  <?php } ?>
                  <tr>
